...
export const TASKS: Task[] = [
  {
    id: "t1",
    projectId: "1",
    title: "결제 모듈 카드 결제 연동",
    column: "todo",
    priority: "높음",
    due: "2026-07-08",
    assignee: "김지훈",
    relatedReq: "카드·간편결제·계좌이체 지원",
  },
  {
    id: "t2",
    projectId: "1",
    title: "간편결제·계좌이체 API 연동",
    column: "todo",
    priority: "중간",
    due: "2026-07-12",
    assignee: "김지훈",
  ...
  },
  {
    id: "t6",
    projectId: "1",
    title: "사용자 활동 감사 로그 구축",
    column: "done",
    priority: "높음",
    due: "2026-06-28",
    assignee: "박민수",
    relatedReq: "사용자 활동 감사 로그",
  },
  {
    id: "t7",
    projectId: "1",
    ...
    due: "2026-07-04",
    assignee: "최예나",
    relatedReq: "30분 이내 복구 이중화 구성",
  },
  {
    id: "t8",
    projectId: "1",
    title: "무중단 배포 파이프라인 구성",
    column: "done",
    priority: "중간",
    due: "2026-06-30",
    assignee: "최예나",
    relatedReq: "무중단(blue-green) 배포",
  },
];
