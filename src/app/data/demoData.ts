...
export type DocumentFileType = "PDF" | "DOCX" | "XLSX" | "PPTX" | "TXT" | "PNG";
...
export const PROJECT_DOCS: DocItem[] = [
  { id: "d1", title: "AI 요구사항 초안", category: "요구사항", status: "PM 승인", version: "v1.2", updatedAt: "2025-07-14", tone: "green", fileType: "DOCX" },
  { id: "d2", title: "PM 확정 요구사항", category: "요구사항", status: "최종 확정", version: "v1.0", updatedAt: "2025-07-14", tone: "teal", fileType: "PDF" },
  { id: "d3", title: "WBS (업무 분류 체계)", category: "프로젝트 계획", status: "AI 생성", version: "v1.0", updatedAt: "2025-07-15", tone: "purple", fileType: "XLSX" },
  { id: "d4", title: "프로젝트 간트 차트", category: "일정 및 WBS", status: "검토 대기", version: "v1.0", updatedAt: "2025-07-15", tone: "yellow", fileType: "PDF" },
  { id: "d5", title: "시스템 아키텍처", category: "구조도", status: "재생성 필요", version: "v1.0", updatedAt: "2025-07-13", tone: "red", fileType: "PNG" },
  { id: "d6", title: "기능 구조도", category: "구조도", status: "AI 생성", version: "v1.0", updatedAt: "2025-07-15", tone: "purple", fileType: "PNG" },
  { id: "d7", title: "사용자 흐름도", category: "화면 설계", status: "PM 승인", version: "v2.0", updatedAt: "2025-07-12", tone: "green", fileType: "PPTX" },
  { id: "d8", title: "리스크 분석 보고서", category: "리스크", status: "검토 대기", version: "v1.1", updatedAt: "2025-07-15", tone: "orange", fileType: "PDF" },
  { id: "d9", title: "역할 및 책임표 (RACI)", category: "프로젝트 계획", status: "PM 수정", version: "v1.0", updatedAt: "2025-07-14", tone: "blue", fileType: "XLSX" },
];
